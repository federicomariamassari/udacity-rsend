...
While the project itself was not as hard as originally expected thanks to the experience I had gained from working on similar tasks, it still posed some challenges during the design, SLAM, navigation, and Pub/Sub communication phases.
